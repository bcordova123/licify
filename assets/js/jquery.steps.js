...
function paginationClickHandler(event)
{
    ...
    switch (href.substring(href.lastIndexOf("#") + 1))
    {
        ...
        var termino = $('#termino').val();
            $.ajax({                                
                url: "http://190.196.222.45/licify/WebPay/pagonormal",
                type: "POST",
                data: {"numero_orden":numero_orden,"termino":termino},
                dataType: 'json',
        ...
        case "next":
            if (state.currentIndex == 0) {
                if (nombre != "") {
                    ...
                    toastr.error("Incorrecto, Ingresa un nombre para tu busqueda");
                    /* $.notify({
                        // options
                        title: 'Incorrecto, ',
                        message: "Ingresa un nombre para tu busqueasddasasdasdda"
                    },{
                        // settings
                        type: 'danger',
                        hideDuration: 7,
                ...
                if (categorias != "" && categorias != null) {               
                    ...
                    toastr.error("Incorrecto, Ingresa al menos una busqueda");
                    /* $.notify({
                        // options
                        title: 'Incorrecto, ',
                        message: "Ingresa busquedas"
                    },{
                        // settings
                        type: 'danger',
                        hideDuration: 7,
