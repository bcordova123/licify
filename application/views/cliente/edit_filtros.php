        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">                 
                    ...
                    if (isset($tipos) && isset($tipos_cliente)):
                ...
                <br>
                    <div class="row">
                        ...
                        <div class="select3 col-md-4">
                            ...
                            <input type="hidden" name="uuid" id="uuid" value="<?=$uuid_cliente?>">  
                        </div>                        
        ...
        function crear_filtros(){
            ...
            var uuid_cliente = $("#uuid").val();
            $.ajax({
                url: "<?=base_url('clientes/add_filter')?>",
                type: "POST",
                data: {"categorias":categorias,"uuid_cliente":uuid_cliente,"tipos":selectedItems},
